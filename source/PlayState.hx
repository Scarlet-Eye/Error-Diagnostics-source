...
class PlayState extends FlxState
{
	...
	override public function update(elapsed:Float)
	{
		...
		if (FlxG.keys.anyJustPressed([FlxKey.SEVEN]))
		{
			...
			new FlxTimer().start(0.1, timerERROR, 3);
			new FlxTimer().start(0.2, timerERROR, 3);
			new FlxTimer().start(0.3, timerERROR, 3);
			new FlxTimer().start(0.4, timerERROR, 3);
			new FlxTimer().start(0.5, timerERROR, 3);
			new FlxTimer().start(0.6, timerERROR, 3);
			new FlxTimer().start(0.7, timerERROR, 3);
			new FlxTimer().start(0.8, timerERROR, 3);
			new FlxTimer().start(0.9, timerERROR, 3);
			new FlxTimer().start(1.0, timerERROR, 3);
			new FlxTimer().start(1.1, timerERROR, 3);
			new FlxTimer().start(1.2, timerERROR, 3);
			new FlxTimer().start(1.3, timerERROR, 3);
			new FlxTimer().start(1.5, timerERROR, 3);
			new FlxTimer().start(1.6, timerERROR, 3);
			new FlxTimer().start(2.8, timerStop, 3);
		}
